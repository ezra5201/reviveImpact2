/**
 * ReVive IMPACT - Contact Log JavaScript
 */
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function setupHeaderEventListeners() {
    ...
    if (searchInput && suggestionsContainer) {
      ...
      searchInput.addEventListener('input', function() {
        ...
        // Render suggestions
        renderClientSuggestions(filteredClients, query, suggestionsContainer);
      });
   ...
   */
  function renderClientSuggestions(clients, query, container) {
    ...
    clients.forEach(client => {
      ...
      item.addEventListener('click', function() {
        document.getElementById('clientSearchInput').value = client;
        container.innerHTML = '';
        container.style.display = 'none';
        
        // Filter table by selected client
